...
export const ReactRouterLogo: React.FC<Props> = ({
  ...
  >
    ...
    <path
      fill="#FFFFFF"
      d="M256 112c-79.4 0-144 64.6-144 144 0 79.4 64.6 144 144 144s144-64.6 144-144c0-79.4-64.6-144-144-144zm-80 144c0-44.2 35.8-80 80-80 17.6 0 33.8 5.7 47 15.3-13.2 31.7-47 112-47 112s-80-35.8-80-47.3zm160 0c0 11.5-35.8 47.3-80 47.3 0-11.5 35.8-47.3 80-47.3z"
    />
