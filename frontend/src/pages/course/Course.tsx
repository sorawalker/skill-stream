    ...
    <div className="course-page">
      ...
      <div className="course-page__container">
        ...
        <div className="course-page__lessons">
          <h2 className="course-page__lessons-title">
            Lessons
          </h2>
          {lessons?.data && lessons.data.length > 0 ? (
              ...
              {lessons.data.map((lesson: Lesson) => (
                ...
                >
                  <div className="course-page__lesson-header">
                    <span className="course-page__lesson-order">
                      Lesson {lesson.order}
                    </span>
                  </div>
                  <h3 className="course-page__lesson-title">
                    {lesson.title}
                  </h3>
                </div>
              ))}
            ...
            <p className="course-page__no-lessons">
